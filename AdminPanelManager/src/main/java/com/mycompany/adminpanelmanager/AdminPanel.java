...
public class AdminPanel extends JFrame implements ActionListener {
    // Declare buttons for add, update, and delete video actions
    ...
    // Constructor
    public AdminPanel() {
        super("Admin Panel"); // Set the title of the window
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(AdminPanel::new); // Create and show the GUI on the Event Dispatch Thread
    }
}
